...
import { Plus, Search, Edit, Trash2, Eye, Star, FolderKanban } from "lucide-react";
              ...
              >
                <div className="col-span-4">
                  <div className="flex items-center gap-2">
                    {project.featured && <Star className="w-3 h-3 fill-yellow-500 text-yellow-500 flex-shrink-0" />}
                    <div>
                ...
                <div className="col-span-2">
                  <span
                    ...
                    style={{
                      backgroundColor: project.status === "ACTIVE" ? "rgb(34 197 94 / 0.1)" : "rgb(59 130 246 / 0.1)",
                      color: project.status === "ACTIVE" ? "rgb(34 197 94)" : "rgb(59 130 246)",
                    }}
                  >
                    {project.status}
                  </span>
                ...
                <div className="col-span-3">
                  <div className="flex flex-wrap gap-1">
                    {project.techStack.slice(0, 2).map((tech) => (
                      <span key={tech} className="text-xs px-1.5 py-0.5 rounded bg-muted text-muted-foreground font-mono">
                        {tech}
                      </span>
                    ))}
                  ...
                  >
                    <Star
                      ...
                      style={{
                        ...
                        color: project.featured ? "rgb(234 179 8)" : "var(--color-muted-foreground)",
                      }}
                    />
                  </button>
                  <Link
